    ...
    <ul className={s.listTable}>
      {items.map(item => (
        <li key={item.id} className={s.tableItem}>
          ...
          <div className={type === 'incomes' ? s.boxAmount : s.boxAmountGreen}>
            <span>
              {type === 'expenses' && `-`}
              {item.amount}
            </span>
            ...
            >
              <g clipPath="url(#clip0_14:254)">
                ...
                />
                <path
                  d="M11.5845 16.3813C11.5938 16.3819 11.6031 16.382 11.6124 16.382C11.891 16.382 12.1239 16.1637 12.1385 15.8821L12.6337 6.37593C12.6488 6.08507 12.4252 5.83691 12.1345 5.82181C11.843 5.80629 11.5956 6.03013 11.5804 6.321L11.0853 15.8272C11.0702 16.1181 11.2936 16.3662 11.5845 16.3813Z"
                  fill="#52555F"
                />
                <path
                  d="M5.89105 15.8833C5.90643 16.1644 6.13906 16.3819 6.41715 16.3819C6.42677 16.3819 6.43665 16.3816 6.4464 16.3811C6.73713 16.3653 6.96001 16.1167 6.94422 15.8259L6.42553 6.31967C6.40974 6.0288 6.16117 5.80592 5.87031 5.82185C5.57959 5.83764 5.3567 6.08621 5.37249 6.37707L5.89105 15.8833Z"
                  fill="#52555F"
                />
                <path
                  d="M9.00891 16.3819C9.30019 16.3819 9.53625 16.1459 9.53625 15.8546V6.34839C9.53625 6.05711 9.30019 5.82104 9.00891 5.82104C8.71764 5.82104 8.48157 6.05711 8.48157 6.34839V15.8546C8.48157 16.1459 8.71764 16.3819 9.00891 16.3819Z"
                  fill="#52555F"
                />
              </g>
              <defs>
